...
(function() {
  ...
  function createCard(item) {
    // Road Trip minigame easter egg
    if (item.id === 'demolition-car' || item.id === 'roadtrip') {
      ...
      }, 'Drive · pit-stop the page · press E to enter');
      ...
      demoCard.addEventListener('click', (e) => window.RoadTrip && window.RoadTrip.activate(e));
