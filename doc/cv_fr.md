...
**Développeur Full-Stack & Architecte de Solutions**

France / Suisse · Français/Anglais (langue maternelle) · +33 6 27 64 80 28 · decastronathan@gmail.com · nathandecastro.com · github.com/Yukisando
...
### Tech Lead, Surgical VR (ex-MedicalVR)
*Amsterdam, Pays-Bas · 2022*

- **PulmoVR** : développement et maintenance d'une application clinique VR pour visualiser des structures anatomiques complexes et accélérer la planification des segmentectomies pulmonaires grâce à la segmentation par machine learning. Résultats validés cliniquement : **-30 min** de temps opératoire moyen pour la VATS 3D face à la VATS 2D, **>97 %** de modèles 3D anatomiquement exacts et **52 %** de plans chirurgicaux modifiés après revue du modèle 3D. *(C#, Unity)*
- Pilotage de l'équipe de développement en Agile/Scrum : sprint planning, daily stand-ups, découpage et délégation des tâches, code reviews et documentation des changements, suivis sur GitHub Projects.
- Pilotage de la mise en conformité **marquage CE** et **ISO 27001** : analyse et réduction des risques de sécurité de l'information, gestion maîtrisée des changements, et documentation technique exigée pour un dispositif médical réglementé.
- Recueil et validation des besoins directement auprès des chirurgiens et du personnel soignant, puis intégration de leurs retours dans le produit.

### Senior Software Engineer, The Barn
*Delft, Pays-Bas · 2019 – 2021*
...
## Projets Freelance & Open Source

**Applications publiées**
- **Spinlab** (Flutter, Firebase, Stripe) : application mobile iOS & Android qui met en relation coachs de tennis et élèves, avec réservation géolocalisée et paiements in-app gérés de bout en bout.
- **Sandlog** (Flutter) : application de journal et de suivi des rêves.
- **Pygmak** (Unity) : jeu mobile avec micro-transactions.

**Projets propriétaires / clients**
...
**Recherche en Game Development**, University of Technology Sydney, 2018, programme accéléré, **Mention Très Bien**
Computer graphics, applications VR pour personnes en situation de handicap, et enseignement du développement de jeux aux étudiants de première année

**Licence en Informatique (BSc Computer Science)**, Goldsmiths, University of London, 2017, **Mention Très Bien**
Machine learning, intelligence artificielle, rendu graphique avancé, traitement audio et vidéo

**Licence Médias, Musique & Son (BA)**, Edge Hill University, 2014, **Mention Très Bien**
