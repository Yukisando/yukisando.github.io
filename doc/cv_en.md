...
France / Switzerland · French/English (native) · +33 6 27 64 80 28 · decastronathan@gmail.com · nathandecastro.com · github.com/Yukisando 

---

## Profile

Full-stack developer and solution architect with **8 years of experience** shipping production software end to end: web platforms, mobile apps, real-time backends and interactive installations running on Android, iOS, Windows and Linux. Owned systems from the first workshop with domain experts through to the deployed, maintained product: architecture, implementation, infrastructure, hardware selection, deployment and support. Heavy daily user and integrator of LLM and agentic AI tooling across the development lifecycle. Comfortable running the technical conversation and the client conversation in the same room.
...
### Technical Lead, Surgical VR (formerly MedicalVR)
*Amsterdam, Netherlands · 2022*

- **PulmoVR**: developed and maintained a VR clinical application to visualise complex anatomical structures and accelerate lung segmentectomy planning through machine-learning segmentation. Clinically validated results: **-30 min** average operating time for 3D VATS vs. 2D VATS, **>97%** anatomically accurate 3D models, and a **52%** surgical plan change rate after 3D model review. *(C#, Unity)*
- Led delivery for the development team within an Agile/Scrum framework: sprint planning, daily stand-ups, task breakdown, delegation, code reviews and change documentation, tracked via GitHub Projects.
- Drove **CE marking** and **ISO 27001** readiness: information-security risk assessment and mitigation, controlled change management, and the technical documentation required for a regulated medical product.
- Ran requirements gathering and validation directly with surgeons and clinical staff, then fed their feedback back into the implementation.

### Senior Software Engineer, The Barn
*Delft, Netherlands · 2019 – 2021*
...
## Selected Freelance Work & Open Source

**Shipped apps**
- **Spinlab** (Flutter, Firebase, Stripe): mobile app for iOS & Android connecting tennis coaches and students, with location-based booking and in-app payments handled end-to-end.
- **Sandlog** (Flutter): dream logging and tracking app.
- **Pygmak** (Unity): mobile game with micro-transactions.
...
**Research in Game Development**, University of Technology Sydney, 2018 accelerated program, **First Class Honours**
Computer graphics implementation, VR applications for the handicapped, and teaching first-year students in game development

**BSc Computer Science**, Goldsmiths, University of London, 2017, **First Class Honours**
Machine learning, artificial intelligence, advanced graphics, audio-visual processing

**BA Media, Music & Sound**, Edge Hill University, 2014, **First Class Honours**
